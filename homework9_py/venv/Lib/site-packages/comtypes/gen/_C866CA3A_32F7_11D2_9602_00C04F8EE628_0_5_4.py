...
__all__ = [
    'DISPID_SPEDisplayAttributes', 'DISPID_SPPChildren', 'SDTAudio',
    'SpFileStream', 'SP_VISEME_2', 'ISpeechPhraseRules',
    'SPSNotOverriden', 'SDTAlternates', 'SPSLMA',
    'DISPID_SRRPhraseInfo', 'ISpRecognizer3',
    'SpeechEmulationCompareFlags', 'DISPID_SpeechLexicon',
    'DISPID_SpeechRecoResultTimes', 'SPEI_MAX_SR',
    'DISPID_SOTCGetDataKey', 'DISPID_SPIElements',
    'SAFT12kHz8BitStereo', 'DISPID_SVSpeakCompleteEvent',
    'SGRSTTTextBuffer', 'SWPKnownWordPronounceable',
    'SPSEMANTICFORMAT', 'SPSHORTCUTPAIRLIST', 'SPEI_ADAPTATION',
    'DISPID_SOTGetStorageFileName', 'SPVISEMES', 'SVSFParseSsml',
    'ISpStreamFormatConverter', 'DISPID_SPAs_NewEnum',
    'SPAUDIOSTATUS', 'SpeechWordPronounceable',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SpeechObjectToken',
    'DISPID_SLGenerationId', 'DISPID_SRCEPropertyNumberChange',
    'DISPID_SABufferNotifySize', 'SpCustomStream',
    ...
    'DISPID_SVSkip', 'SPRECOSTATE', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SVEStreamStart', 'ISpeechObjectToken',
    'ISpeechResourceLoader', 'DISPID_SRRRecoContext',
    'SECFIgnoreKanaType', 'SRSEDone', 'ISpNotifySource',
    'SAFTADPCM_8kHzStereo', 'DISPID_SVRate', 'SP_VISEME_19',
    'SPINTERFERENCE_TOOLOUD', 'SRAImport', 'DISPID_SRSAudioStatus',
    'SpeechStreamSeekPositionType', 'SpeechFormatType',
    'DISPID_SVEPhoneme', 'DISPID_SGRsCommitAndSave', 'SpWaveFormatEx',
    'ISpeechMemoryStream', 'SVSFUnusedFlags', 'DISPID_SRRTLength',
    'SVF_None', 'SINoSignal', 'SAFTGSM610_8kHzMono',
    'DISPID_SLPSymbolic', 'ISpeechPhraseAlternates',
    'DISPID_SGRsCount', 'ISpObjectWithToken', 'SPAUDIOOPTIONS',
    'SSSPTRelativeToStart', 'DISPID_SPRulesItem',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SPPEngineConfidence',
    'SPSModifier', 'DISPID_SDKGetlongValue', 'SAFT16kHz16BitMono',
    'SP_VISEME_13', 'DISPID_SPEEngineConfidence', 'SVEVoiceChange',
    'SpeechWordType', 'DISPID_SGRSAddRuleTransition', 'SP_VISEME_8',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SPIEngineId', 'SP_VISEME_4',
    'DISPID_SLWs_NewEnum', 'SPWORDPRONUNCIATION', 'SVP_3', 'SpStream',
    'DISPID_SpeechPhraseProperties', 'SPSTREAMFORMATTYPE',
    'DISPID_SVSInputWordLength', 'SGRSTTWildcard', 'SPEI_REQUEST_UI',
    'ISpeechAudioBufferInfo', 'DISPID_SOTCDefault',
    'ISpeechMMSysAudio', 'DISPID_SRCResume',
    'DISPID_SpeechAudioFormat', 'SVSFParseAutodetect',
    'ISpeechAudioFormat', 'DISPID_SVSLastBookmarkId', 'SPRS_ACTIVE',
    'DISPID_SRSetPropertyNumber', 'DISPID_SPELexicalForm',
    'SPWT_PRONUNCIATION', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SRCEPhraseStart', 'DISPID_SpeechFileStream',
    'DISPID_SABIBufferSize', 'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SRCEAdaptation', 'DISPID_SRRAudio',
    'DISPID_SRRDiscardResultInfo', 'SP_VISEME_7',
    'SPINTERFERENCE_TOOSLOW', 'ISpeechLexicon', 'SPPHRASEREPLACEMENT',
    'SpeechRuleAttributes', 'SAFTCCITT_ALaw_44kHzMono',
    'DISPID_SLWLangId', 'DISPID_SLPLangId',
    'ISpeechPhraseReplacements', 'SpeechAudioVolume',
    'DISPID_SpeechObjectTokens', 'DISPID_SPRs_NewEnum',
    'SAFTADPCM_11kHzMono', 'DISPID_SREmulateRecognition',
    'SAFTCCITT_uLaw_22kHzMono', 'SPVPRI_OVER', 'ISpeechFileStream',
    'SREHypothesis', 'SPINTERFERENCE', 'SAFT44kHz8BitMono',
    'eLEXTYPE_PRIVATE4', 'DISPID_SVAudioOutput', 'eLEXTYPE_PRIVATE10',
    'SP_VISEME_3', 'DISPID_SOTId', 'DISPID_SPCLangId',
    'SVEEndInputStream', 'DISPID_SPIAudioSizeBytes', 'SVPOver',
    'SPSHORTCUTPAIR', 'DISPID_SGRSTType', 'SPPS_LMA', 'SPSHT_Unknown',
    'SAFTCCITT_uLaw_11kHzMono', 'ISpeechRecoContext',
    'DISPID_SPCIdToPhone', 'DISPID_SGRSTs_NewEnum', 'SPSInterjection',
    'DISPID_SGRsCommit', 'SPBO_PAUSE', 'SPPS_Modifier',
    'SpUnCompressedLexicon', 'ISpPhoneConverter',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SGRsAdd',
    'SpeechVisemeFeature', 'DISPID_SOTDisplayUI', 'SVP_19',
    ...
    'DISPID_SRCSetAdaptationData', 'DISPID_SRCCmdMaxAlternates',
    'SRAInterpreter', 'SPRECOGNIZERSTATUS',
    'SpeechGrammarTagUnlimitedDictation', 'SAFT8kHz8BitStereo',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SpeechBaseStream',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SVEEnginePrivate',
    'DISPID_SRCPause', 'STCInprocHandler', 'DISPID_SPAsCount',
    'DISPID_SBSFormat', 'SPEI_PROPERTY_NUM_CHANGE',
    'SECLowConfidence', 'SpeechAudioFormatGUIDWave',
    'SPRECORESULTTIMES', 'SPPS_Noun',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SP_VISEME_1',
    'Speech_StreamPos_Asap', 'DISPID_SCSBaseStream',
    'DISPID_SPEPronunciation', 'DISPID_SPRulesCount', 'SP_VISEME_5',
    'SDTAll', 'eLEXTYPE_MORPHOLOGY', 'SPPS_Unknown',
    'DISPID_SpeechPhoneConverter', 'SREFalseRecognition',
    'SPEI_FALSE_RECOGNITION', 'ISpeechPhraseElement',
    'SAFT48kHz8BitMono', 'SRARoot', 'SpeechAudioProperties',
    ...
    'SAFT11kHz8BitMono', 'SVEWordBoundary', 'SLTApp',
    'SREPropertyNumChange',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SAFTGSM610_22kHzMono', 'DISPID_SMSSetData', 'DISPID_SGRsDynamic',
    'DISPID_SVDisplayUI', 'DISPID_SpeechMMSysAudio',
    'DISPID_SPACommit', 'SpeechGrammarWordType', 'SREAllEvents',
    'DISPID_SRGSetWordSequenceData', 'SREPrivate', 'DISPID_SRCVoice',
    'DISPID_SpeechRecoContext', 'SRTExtendableParse',
    'SAFT16kHz8BitMono', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SPRules_NewEnum', 'SP_VISEME_16', 'ISpRecognizer',
    'DISPID_SVEStreamEnd', 'SPPHRASEELEMENT',
    'DISPID_SRCERecognitionForOtherContext', 'Speech_Max_Pron_Length',
    'SWPUnknownWordUnpronounceable', 'DISPID_SASCurrentSeekPosition',
    'SPAO_RETAIN_AUDIO', 'SPPS_RESERVED4', 'SpeechVoicePriority',
    'SpeechVoiceCategoryTTSRate', 'SpeechLexiconType',
    'SRERecoOtherContext', 'SPEI_RESERVED1', 'ISpeechGrammarRules',
    'SP_VISEME_18', 'SPAS_PAUSE', 'ISpeechRecoResult',
    'DISPID_SRCRetainedAudio', 'SVSFIsNotXML', 'ISpeechPhraseRule',
    'DISPID_SOTRemoveStorageFileName', 'SAFTGSM610_11kHzMono',
    'eLEXTYPE_PRIVATE2', 'SPEI_RECOGNITION', 'SPCONTEXTSTATE',
    'ISpObjectTokenCategory', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SRRSetTextFeedback', 'SGLexicalNoSpecialChars',
    'IInternetSecurityMgrSite', 'ISpEventSink', 'SDTRule',
    'SRATopLevel', 'SAFT12kHz16BitStereo', 'SpeechAddRemoveWord',
    'ISpeechCustomStream', 'DISPID_SGRName', 'DISPID_SRCERequestUI',
    'SpeechRecognitionType', 'SDKLLocalMachine', 'SRTSMLTimeout',
    'SAFT24kHz16BitMono', 'SPAUDIOSTATE', 'SPSHT_NotOverriden',
    'DISPID_SpeechVoiceEvent', 'SVP_10', 'DISPID_SAVolume',
    'SpeechAllElements', 'DISPID_SVGetProfiles', 'SPRST_ACTIVE',
    'DISPID_SPRuleChildren', 'DISPID_SPIProperties',
    'SPINTERFERENCE_NONE', 'SPCT_SUB_COMMAND',
    'SAFTTrueSpeech_8kHz1BitMono', 'SRTAutopause', 'DISPID_SPPsCount',
    'DISPID_SRCRequestedUIType', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SRESoundEnd', 'SREAdaptation', 'SPWORDPRONUNCIATIONLIST',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SPPId',
    'SPINTERFERENCE_NOSIGNAL', 'SPDKL_CurrentConfig',
    'DISPID_SPEAudioTimeOffset',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SRIsUISupported', 'DISPID_SPANumberOfElementsInResult',
    'SPGRAMMARSTATE', 'SP_VISEME_15', 'SpeechDisplayAttributes',
    'SASClosed', 'SPCT_DICTATION', 'eLEXTYPE_PRIVATE9',
    'DISPID_SRCEFalseRecognition', 'SPWORDTYPE',
    'DISPID_SDKDeleteKey', 'SAFTDefault', 'SP_VISEME_17',
    'SpShortcut', 'ISpeechLexiconPronunciations',
    'DISPID_SpeechPhraseElements', 'SASPause', 'eLEXTYPE_RESERVED10',
    'SPEI_RESERVED2', 'DISPID_SpeechPhraseRule',
    'SpeechAudioFormatType', 'DISPID_SDKCreateKey', 'SRSEIsSpeaking',
    'DISPID_SRGCmdLoadFromFile', 'SAFTADPCM_44kHzStereo',
    'DISPID_SVSpeak', 'SWPUnknownWordPronounceable', 'SECFIgnoreCase',
    'DISPID_SPRNumberOfElements', 'SAFT48kHz16BitMono',
    'SpeechInterference', 'SAFTCCITT_uLaw_44kHzMono', 'SGDisplay',
    'ISpRecoCategory', 'eLEXTYPE_PRIVATE16',
    'SpeechCategoryAppLexicons', 'DISPID_SpeechPhraseElement',
    'SVEStartInputStream', 'SPEI_RESERVED6', 'SVSFIsFilename',
    'SVP_18', 'SPXMLRESULTOPTIONS', 'DISPID_SRGCmdSetRuleIdState',
    'SP_VISEME_20', 'SAFT32kHz16BitStereo',
    'DISPID_SpeechXMLRecoResult', 'SAFT8kHz16BitStereo', 'SVSFIsXML',
    'ISpeechPhraseElements', 'SPLOADOPTIONS', 'SpMMAudioEnum',
    'SREStateChange', 'DISPIDSPTSI', 'SAFT11kHz16BitStereo',
    'SpeechRecoProfileProperties', 'SP_VISEME_21', 'ISpProperties',
    'ISpRecognizer2', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SRCVoicePurgeEvent', 'SGRSTTRule', 'SpeechTokenKeyFiles',
    'SPEI_PHONEME', 'tagSPTEXTSELECTIONINFO', 'eLEXTYPE_PRIVATE18',
    'SPFM_OPEN_READWRITE', 'DISPID_SRGCommit', 'DISPIDSPRG',
    'SpeechGrammarState', 'DISPID_SRCEEndStream',
    'DISPID_SPPFirstElement', 'DISPID_SPEsItem', 'ISpStream',
    'DISPID_SRGRecoContext', 'SPCS_DISABLED', 'DISPID_SRCEHypothesis',
    'DISPID_SGRClear', 'SpResourceManager', 'DISPID_SRCERecognition',
    'ISpRecoGrammar', 'SASRun', 'DISPID_SPPName',
    'SPEI_START_INPUT_STREAM', 'DISPID_SVSVisemeId',
    'DISPID_SDKSetBinaryValue', 'SVSFVoiceMask',
    'DISPID_SGRsFindRule', 'DISPID_SVSCurrentStreamNumber',
    'SpeechTokenIdUserLexicon', 'SPEI_WORD_BOUNDARY',
    'DISPID_SVVolume', 'SSFMOpenForRead', 'SAFT16kHz16BitStereo',
    'SPSERIALIZEDRESULT', 'eLEXTYPE_PRIVATE7', 'IEnumString',
    'SpeechVoiceEvents', 'DISPID_SPEAudioStreamOffset', 'SPSHT_OTHER',
    'DISPID_SGRSTPropertyName', 'DISPID_SRCEPropertyStringChange',
    'SRAExport', 'SpeechVoiceSpeakFlags',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SDKGetStringValue',
    'SPWT_DISPLAY', 'SSSPTRelativeToCurrentPosition', 'SPPHRASE',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SGRsItem',
    'DISPID_SOTs_NewEnum', 'DISPIDSPTSI_SelectionOffset',
    'DISPID_SpeechDataKey', 'UINT_PTR', 'DISPID_SOTRemove',
    'DISPID_SRSClsidEngine', 'DISPID_SRCEventInterests',
    'DISPID_SPRsCount', 'DISPID_SPIAudioSizeTime',
    'DISPID_SRGCmdLoadFromObject', 'SpeechCategoryVoices',
    'ISpeechRecognizerStatus', 'SpeechTokenShellFolder',
    'DISPID_SRRTStreamTime', 'SpeechAudioState',
    'DISPID_SLRemovePronunciationByPhoneIds',
    '_ISpeechRecoContextEvents', 'SPPS_Function',
    'SpeechEngineProperties', 'SP_VISEME_9',
    'DISPID_SpeechRecognizerStatus', 'SPEI_HYPOTHESIS',
    'eLEXTYPE_USER_SHORTCUT', 'SVSFNLPMask', 'ISpStreamFormat',
    'SAFT22kHz16BitStereo', 'SREInterference',
    'SAFTADPCM_22kHzStereo', 'DISPID_SpeechGrammarRules',
    'SpMMAudioOut', 'DISPID_SGRSTText', 'SAFTCCITT_ALaw_22kHzMono',
    'DISPID_SRCBookmark', 'DISPID_SDKSetLongValue',
    'DISPID_SGRSTsItem', 'SPLO_DYNAMIC', 'DISPID_SLPPhoneIds',
    'SPFM_CREATE_ALWAYS', 'SVSFDefault', 'SGRSTTDictation',
    'SpeechRetainedAudioOptions', 'ISpGrammarBuilder', 'SP_VISEME_11',
    'SINone', 'DISPID_SAFType', 'SpeechTokenKeyUI', 'SPCATEGORYTYPE',
    'DISPID_SDKSetStringValue', 'DISPID_SRStatus',
    'DISPID_SVSLastResult', 'DISPID_SOTDataKey', 'SVEPrivate',
    'DISPID_SOTGetAttribute', 'SpAudioFormat',
    'DISPID_SRCEAudioLevel', 'SpeechPropertyResponseSpeed',
    'DISPID_SMSAMMHandle', 'SPAR_Low', 'SAFTCCITT_uLaw_44kHzStereo',
    'ISpeechDataKey', 'ISpPhoneticAlphabetSelection',
    'DISPID_SPEDisplayText', 'DISPID_SLWPronunciations',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SGSExclusive',
    'DISPID_SPIGrammarId', 'SpPhoneticAlphabetConverter', 'SBONone',
    'SPWORDPRONOUNCEABLE', 'SPFM_NUM_MODES', 'SPEI_SOUND_END',
    'DISPID_SRCESoundStart', 'DISPID_SPRuleEngineConfidence',
    'SpeechPropertyHighConfidenceThreshold', 'DISPID_SDKDeleteValue',
    'DISPID_SPIGetText', 'SAFTNonStandardFormat', 'DISPID_SLWsItem',
    'DISPID_SRCCreateGrammar', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SPEsCount', 'DISPID_SVStatus', 'ISpeechPhraseInfoBuilder',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'DISPID_SPIRule',
    'DISPID_SVAlertBoundary', 'DISPID_SVGetVoices',
    'DISPID_SABIEventBias', 'SRTEmulated', 'SPDKL_DefaultLocation',
    'DISPID_SRCEEnginePrivate', 'DISPID_SBSRead',
    'DISPID_SRCEStartStream', 'DISPID_SpeechPhraseReplacements',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SGRSTransitions',
    'SVF_Emphasis', 'SDTReplacement', 'SpeechRecoEvents',
    'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SLODynamic',
    'DISPID_SOTsCount', 'SAFT22kHz8BitMono', 'SAFTADPCM_44kHzMono',
    'ISpeechXMLRecoResult', 'DISPID_SPILanguageId',
    'DISPID_SRCRecognizer', 'SREStreamEnd', 'SPSHORTCUTTYPE',
    'SGDSInactive', 'DISPID_SRRGetXMLErrorInfo', 'SPAS_RUN',
    'eLEXTYPE_PRIVATE17', 'SPSHT_EMAIL', 'SREAudioLevel',
    'SAFT44kHz16BitStereo', 'DISPID_SMSALineId', 'eLEXTYPE_PRIVATE20',
    'DISPID_SpeechPhraseRules', 'SAFT11kHz16BitMono',
    'DISPID_SLPType', 'DISPID_SGRAddResource', 'DISPID_SOTsItem',
    'ISpObjectToken', 'eLEXTYPE_PRIVATE14', 'SVEBookmark',
    'DISPID_SGRSTsCount', 'DISPID_SpeechLexiconProns',
    'eLEXTYPE_PRIVATE5', 'SPWORD', 'DISPID_SpeechCustomStream',
    'DISPID_SVESentenceBoundary', 'DISPID_SRGetPropertyNumber',
    'DISPID_SPRuleParent', 'SP_VISEME_12',
    'DISPID_SRCERecognizerStateChange', 'ISpeechRecoResult2',
    'SGDSActiveUserDelimited', 'SVP_2', 'SPCT_SLEEP',
    'SPEI_SR_PRIVATE', 'ISpPhrase', 'DISPID_SRCreateRecoContext',
    'SpNullPhoneConverter', 'SPAO_NONE', 'DISPID_SPPNumberOfElements',
    'DISPID_SASFreeBufferSpace', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SPRuleId', 'ISpeechObjectTokenCategory', 'ISpLexicon',
    'SP_VISEME_10', 'DISPID_SLPsCount', 'SVF_Stressed',
    'SSTTWildcard', 'SRADynamic', 'SPEVENTENUM',
    'DISPID_SPRuleNumberOfElements', 'SRADefaultToActive',
    'SPRECOCONTEXTSTATUS', 'ISpNotifySink', 'SPEI_SOUND_START',
    'SpeechRecognizerState', 'ISpMMSysAudio', 'SRERecognition',
    'DISPID_SRRSaveToMemory', 'DISPID_SRGReset',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SGRSTRule',
    'ISpeechPhraseProperty', 'DISPID_SLPPartOfSpeech',
    'DISPID_SpeechRecoResult', 'DISPID_SpeechPhraseInfo', 'SPBO_NONE',
    'IEnumSpObjectTokens', 'SPSUnknown',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SSSPTRelativeToEnd',
    'SPADAPTATIONRELEVANCE', 'SPBO_AHEAD', 'SGSEnabled',
    'ISpeechGrammarRule', 'SGSDisabled',
    'SpeechCategoryPhoneConverters', 'SpeechSpecialTransitionType',
    'DISPID_SBSWrite', 'STCAll', 'DISPID_SPAPhraseInfo',
    'SVSFParseMask', 'DISPID_SVPause', 'SPPROPERTYINFO',
    'SPDKL_LocalMachine', 'SAFT32kHz8BitMono', '_ISpeechVoiceEvents',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SGRSRule', 'STSF_FlagCreate',
    'ISpeechGrammarRuleState', 'SpeechEngineConfidence', 'SPXRO_SML',
    'SpInprocRecognizer', 'DISPID_SPIStartTime', 'STCLocalServer',
    'STSF_AppData', 'SPEI_MIN_TTS', 'SAFTText',
    'DISPID_SLAddPronunciation', 'ISequentialStream',
    'SPRST_ACTIVE_ALWAYS', 'SpLexicon', 'SpeechCategoryRecognizers',
    'SPEI_INTERFERENCE', 'SpeechGrammarTagWildcard',
    'SAFT44kHz8BitStereo', 'SpStreamFormatConverter',
    'DISPID_SpeechAudioStatus', 'DISPID_SWFEFormatTag',
    'DISPID_SRState', 'SPEI_RESERVED5', 'SPPS_Verb',
    'eWORDTYPE_ADDED', 'eLEXTYPE_APP', 'eLEXTYPE_RESERVED9',
    'SAFT11kHz8BitStereo', 'SSFMCreateForWrite', 'SPFM_CREATE',
    'SVP_7', 'SPGRAMMARWORDTYPE', 'SDKLCurrentUser',
    'SGDSActiveWithAutoPause', 'SAFT44kHz16BitMono',
    'DISPID_SPEs_NewEnum', 'DISPID_SABIMinNotification',
    'DISPID_SVEventInterests', 'SPRST_NUM_STATES',
    'SpeechUserTraining', 'eLEXTYPE_VENDORLEXICON', 'DISPID_SRGRules',
    'DISPID_SVVoice', '_RemotableHandle', 'DISPID_SGRSTPropertyId',
    'DISPID_SpeechLexiconWords', 'DISPID_SLPs_NewEnum',
    'DISPID_SRRGetXMLResult', 'DISPID_SRCEBookmark', 'SPRULE',
    'eLEXTYPE_PRIVATE6', 'SREPhraseStart',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SPRuleConfidence', 'DISPID_SVWaitUntilDone',
    'DISPID_SGRs_NewEnum', 'SPFM_OPEN_READONLY',
    'DISPID_SRCAudioInInterferenceStatus', 'SPDKL_CurrentUser',
    'SRSActive', 'SPSERIALIZEDPHRASE', 'SDKLCurrentConfig',
    'ISpResourceManager', 'ISpeechVoiceStatus', 'DISPID_SGRId',
    ...
    'SPCT_SUB_DICTATION', 'SPPS_NotOverriden', 'ISpRecoResult',
    ...
    'SpeechRegistryUserRoot', 'ISpPhoneticAlphabetConverter',
    'DISPID_SDKEnumKeys', 'DISPID_SAFGetWaveFormatEx', 'IStream',
    'SPLEXICONTYPE', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SRAORetainAudio', 'DISPID_SOTMatchesAttributes',
    'DISPID_SRProfile', 'SpeechDiscardType', 'DISPID_SPIReplacements',
    'SpSharedRecoContext', 'SECNormalConfidence', 'SRTReSent',
    'DISPID_SOTSetId', 'ISpAudio', 'SPEI_UNDEFINED',
    'SpeechCategoryAudioOut', 'DISPID_SRCState',
    '__MIDL_IWinTypes_0009', 'DISPID_SRRTimes', 'SPEI_VISEME',
    'SDTProperty', 'eLEXTYPE_PRIVATE11', 'DISPID_SLWsCount',
    'SAFTExtendedAudioFormat', 'DISPIDSPTSI_SelectionLength',
    'SAFT24kHz8BitStereo', 'SRTStandard', 'DISPID_SOTCategory',
    'SSFMOpenReadWrite', 'DISPID_SPRFirstElement',
    'SPRST_INACTIVE_WITH_PURGE', 'SpMMAudioIn',
    'Speech_Max_Word_Length', 'SVP_5', 'SWTDeleted',
    'SpeechGrammarRuleStateTransitionType', 'SPRS_INACTIVE',
    'DISPID_SAFSetWaveFormatEx', 'eWORDTYPE_DELETED',
    'DISPID_SpeechRecognizer', 'DISPID_SpeechAudio', 'SSTTTextBuffer',
    'SITooSlow', 'ISpRecoContext2', 'SPWF_SRENGINE', 'ISpShortcut',
    'eLEXTYPE_USER', 'DISPID_SpeechVoice', 'Speech_Default_Weight',
    'DISPID_SpeechRecoContextEvents', 'DISPIDSPTSI_ActiveLength',
    'SpeechCategoryRecoProfiles', 'SRERequestUI',
    'ISpeechGrammarRuleStateTransition', 'SPEI_VOICE_CHANGE',
    'DISPID_SpeechPhraseProperty', 'DISPID_SPIGetDisplayAttributes',
    'SPAS_CLOSED', 'DISPID_SRCCreateResultFromMemory',
    'ISpSerializeState', 'DISPID_SVGetAudioOutputs', '_SPAUDIOSTATE',
    'DISPID_SWFEExtraData', 'SDA_One_Trailing_Space',
    'DISPID_SGRAddState', 'DISPID_SPARecoResult',
    'Speech_StreamPos_RealTime', 'ISpeechAudioStatus',
    'DISPID_SRGetPropertyString', 'SPXRO_Alternates_SML',
    'SPGS_EXCLUSIVE', 'DISPID_SVSRunningState', 'SBOPause',
    'SpeechTokenKeyAttributes', 'SpVoice', 'SPVPRI_ALERT',
    ...
    'SpeechDataKeyLocation', 'DISPID_SpeechGrammarRule',
    'SP_VISEME_6', 'DISPID_SDKGetBinaryValue',
    'SAFTCCITT_uLaw_8kHzStereo', 'SAFTGSM610_44kHzMono',
    'DISPID_SPRText', 'DISPID_SRSetPropertyString', 'DISPID_SPPValue',
    'SPPS_RESERVED3', 'SpeechGrammarTagDictation', 'SWTAdded',
    'ISpeechPhraseInfo', 'DISPID_SRCRetainedAudioFormat',
    'DISPID_SFSClose', 'DISPID_SRRAlternates', 'SVSFNLPSpeakPunc',
    'DISPID_SVEViseme', 'SDTPronunciation', 'SAFT8kHz8BitMono',
    'SGPronounciation', 'SGRSTTWord', 'DISPID_SPCPhoneToId',
    'SpeechRuleState', 'SAFT8kHz16BitMono', 'SPWORDLIST',
    'SPPS_RESERVED1', 'ISpeechPhoneConverter',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SPFILEMODE',
    'SPSSuppressWord', 'ISpeechObjectTokens', 'eLEXTYPE_PRIVATE1',
    'SPSMF_UPS', 'DISPID_SpeechPhraseReplacement', 'SRSInactive',
    'SGRSTTEpsilon', 'DISPID_SGRSTWeight', 'DISPID_SRRAudioFormat',
    'DISPID_SPEActualConfidence', 'ISpeechVoice',
    'DISPID_SRRTTickCount', 'SpeechMicTraining',
    'DISPID_SRGDictationLoad', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SRAudioInput', 'DISPID_SPIEnginePrivateData',
    'DISPID_SPRuleFirstElement', 'eLEXTYPE_PRIVATE19',
    'SPSEMANTICERRORINFO', 'DISPID_SOTIsUISupported',
    'SVSFPurgeBeforeSpeak', 'DISPID_SLWWord',
    'DISPID_SGRSAddWordTransition', 'DISPID_SVSpeakStream',
    'SpeechPartOfSpeech', 'DISPID_SOTCId', 'SAFT22kHz16BitMono',
    'SVP_8', 'SPCS_ENABLED', 'DISPID_SGRSTPropertyValue', 'SINoise',
    'SPEI_END_SR_STREAM', 'DISPID_SASetState', 'DISPID_SVSPhonemeId',
    'SAFT24kHz8BitMono', 'DISPID_SAFGuid', 'SVPAlert',
    'ISpeechLexiconWord', 'SP_VISEME_14', 'SECHighConfidence',
    'SRESoundStart', 'SAFTADPCM_8kHzMono', 'SPPS_Interjection',
    'SPPS_SuppressWord', 'SPAS_STOP', 'SPVOICESTATUS',
    'SRCS_Disabled', 'SAFTNoAssignedFormat', 'SVP_6', 'SVEPhoneme',
    'eLEXTYPE_PRIVATE3', 'SpSharedRecognizer', 'SAFT12kHz16BitMono',
    'DISPID_SRSCurrentStreamPosition', 'SAFTADPCM_11kHzStereo',
    'DISPID_SPEAudioSizeTime', 'DISPID_SpeechRecoResult2',
    'SpPhraseInfoBuilder', 'eLEXTYPE_RESERVED8', 'SVEViseme',
    'ISpPhraseAlt', 'STCInprocServer',
    'DISPID_SVSInputSentenceLength', 'DISPID_SPRuleName',
    'STCRemoteServer', 'IInternetSecurityManager', 'SpeechVisemeType',
    'DISPID_SLPsItem', 'SECFNoSpecialChars',
    'DISPID_SPIAudioStreamPosition', 'eLEXTYPE_PRIVATE13', 'LONG_PTR',
    'SpObjectToken', 'SPBOOKMARKOPTIONS', 'eLEXTYPE_RESERVED4',
    'SPGS_DISABLED', 'SVSFPersistXML', 'DISPID_SPAsItem',
    'SPEI_TTS_AUDIO_LEVEL', 'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SpeechLexiconWord', 'SPEI_SR_BOOKMARK',
    'SpPhoneConverter', 'SPPHRASEPROPERTY', 'SGLexical',
    'SPTEXTSELECTIONINFO', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SVESentenceBoundary', 'DISPID_SVEAudioLevel',
    'DISPID_SVGetAudioInputs', 'ISpDataKey', 'DISPID_SWFEChannels',
    'SVP_17', 'SPWF_INPUT', 'SpTextSelectionInformation',
    'DISPID_SVSLastBookmark', 'SREBookmark', 'DISPID_SVResume',
    'DISPID_SMSGetData', 'SASStop', 'DISPID_SPERetainedStreamOffset',
    'SpMemoryStream', 'SECFIgnoreWidth', 'SECFEmulateResult',
    'tagSPPROPERTYINFO', 'SpeechLoadOption',
    'DISPID_SPPBRestorePhraseFromMemory', 'ISpeechAudio',
    'DISPID_SRAudioInputStream', 'DISPID_SGRInitialState', 'SLTUser',
    'SVP_4', 'DISPID_SAEventHandle', 'SpeechStreamFileMode',
    'SPVPRI_NORMAL', 'SVEAudioLevel', 'DISPID_SBSSeek',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SRGCmdLoadFromResource',
    'SREStreamStart', 'ISpeechPhraseReplacement',
    'DISPID_SOTGetDescription', 'SVP_12', 'SVSFlagsAsync', 'SVP_15',
    'SREPropertyStringChange', 'DISPID_SAStatus', 'DISPID_SFSOpen',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SGRAttributes',
    'DISPID_SRCEInterference', 'DISPID_SDKOpenKey', 'SVP_21',
    'SAFTCCITT_ALaw_11kHzStereo', 'tagSTATSTG',
    'DISPID_SRSCurrentStreamNumber', 'SDA_No_Trailing_Space',
    'SAFT32kHz16BitMono', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SpeechRecoContextState', 'DISPID_SRGetRecognizers',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SWFESamplesPerSec',
    'SPWAVEFORMATTYPE', 'SITooQuiet',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SWFEBitsPerSample', 'SPEVENT', 'SpInProcRecoContext',
    'SRAONone', 'SPRULESTATE', 'SPINTERFERENCE_NOISE',
    'SPPS_RESERVED2', 'SPVPRIORITY',
    'DISPID_SVSInputSentencePosition', 'DISPID_SLGetWords',
    'SPEI_START_SR_STREAM', 'ISpeechRecognizer',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SOTCSetId', 'SVP_9',
    'STSF_LocalAppData', 'eLEXTYPE_PRIVATE15',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SpeechAudioBufferInfo',
    'ISpVoice', 'DISPID_SRRecognizer', 'SPAR_Medium', 'SRCS_Enabled',
    'SPLO_STATIC', 'SAFTADPCM_22kHzMono', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SPPS_Noncontent', 'SPSFunction', 'DISPID_SVEWord',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SpeechVoiceStatus',
    'SPPHRASERULE', 'SpeechTokenContext', 'DISPID_SRIsShared',
    'DISPID_SPPsItem', 'SPAUDIOBUFFERINFO', 'SpeechBookmarkOptions',
    'SPEI_PHRASE_START', 'DISPID_SVSInputWordPosition',
    'DISPID_SLGetPronunciations', 'SPDATAKEYLOCATION',
    'DISPID_SpeechPhraseAlternates', 'SPBINARYGRAMMAR',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SOTCreateInstance',
    'SDTDisplayText', 'SPEI_TTS_PRIVATE',
    'ISpeechGrammarRuleStateTransitions',
    'DISPID_SLGetGenerationChange', 'SDKLDefaultLocation', 'SVP_16',
    'DISPID_SpeechWaveFormatEx', 'SpCompressedLexicon',
    'DISPID_SRGCmdSetRuleState', 'SAFT16kHz8BitStereo',
    'SDA_Two_Trailing_Spaces', 'SPCT_COMMAND',
    'SpObjectTokenCategory', 'DISPID_SLWType', 'SVP_20',
    'DISPID_SPEAudioSizeBytes', 'SITooFast', 'STSF_CommonAppData',
    'SFTInput', 'DISPID_SLRemovePronunciation', 'DISPID_SRGetFormat',
    'SLOStatic', 'DISPID_SRGState', 'DISPID_SGRSAddSpecialTransition',
    'SVEAllEvents', 'SpeechCategoryAudioIn', 'WAVEFORMATEX',
    'DISPID_SVPriority', 'SPBO_TIME_UNITS', 'DISPID_SABufferInfo',
    'DISPID_SVEBookmark', 'SGDSActive',
    'DISPID_SRSNumberOfActiveRules', 'SpNotifyTranslator',
    'ISpeechPhraseAlternate', 'DISPID_SRCESoundEnd', 'SVP_11',
    'SSFMCreate', 'SFTSREngine', 'SPGS_ENABLED', 'SRSActiveAlways',
    'SRSInactiveWithPurge', 'ISpRecoGrammar2', 'DISPID_SPPs_NewEnum',
    'SPEVENTSOURCEINFO', 'SPEI_RESERVED3', 'eLEXTYPE_RESERVED6',
    'SpeechTokenValueCLSID', 'SPEI_RECO_STATE_CHANGE',
    'SpeechPropertyResourceUsage', 'ISpNotifyTranslator', 'SVP_0',
    'SDTLexicalForm', 'SVPNormal', 'SAFT22kHz8BitStereo', 'SPSVerb',
    'SAFT48kHz8BitStereo', 'ISpeechRecoResultDispatch',
    'SPEI_MAX_TTS', 'SPEI_END_INPUT_STREAM', 'SECFDefault',
    'SPEI_TTS_BOOKMARK', 'DISPID_SVAudioOutputStream',
    'ISpRecoContext', 'SPAR_Unknown', 'SITooLoud',
    'DISPID_SRDisplayUI', 'DISPID_SRGId',
    'DISPID_SpeechPhraseAlternate', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SVSFParseSapi', 'SAFTCCITT_ALaw_8kHzStereo', 'ISpEventSource',
    'SPEI_MIN_SR', 'ISpeechRecoGrammar',
    'DISPID_SRSSupportedLanguages', 'DISPID_SPRsItem', 'SPSNoun',
    'SPWT_LEXICAL', 'SVP_13', 'DISPID_SRGIsPronounceable',
    'SpeechRunState', 'SAFT48kHz16BitStereo', 'SAFT12kHz8BitMono',
    'DISPID_SRRSpeakAudio', 'SpeechAudioFormatGUIDText',
    'DISPID_SRGDictationUnload', 'eLEXTYPE_PRIVATE12',
    'ISpeechLexiconPronunciation', 'SVP_14', 'DISPID_SDKEnumValues',
    'ISpXMLRecoResult', 'eLEXTYPE_RESERVED7', 'eLEXTYPE_PRIVATE8',
    'DISPID_SGRSTNextState', 'SPINTERFERENCE_TOOFAST', 'SPAR_High',
    'SVP_1', 'DISPID_SPPParent', 'DISPID_SPPConfidence',
    'DISPID_SpeechGrammarRuleStateTransitions'
]

_check_version('1.1.14', 1610598606.043558)
